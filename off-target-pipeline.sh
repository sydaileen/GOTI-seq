...
perl filter_overlap.pl ${WORK_DIR}/scalpel/${pos}/somatic_final.indels.vcf ${WORK_DIR}/strelka/${pos}/results/variants/somatic.indels.pass.vcf ${WORK_DIR}/mutect/${pos}/output.pass.indel.vcf ${WORK_DIR}/${pos}.indel.overlap.vcf
...
perl awk_anno.pl ${WORK_DIR}/${pos}.snv.overlap.vcf.anno.mm10_multianno.txt ${WORK_DIR}/${pos}.snv.anno.tsv
awk '$10>0.1 {print $0}' ${WORK_DIR}/${pos}.snv.anno.tsv > ${WORK_DIR}/${pos}.snv.anno.0.1.tsv

${SOFT}/annovar/table_annovar.pl  ${WORK_DIR}/${pos}.indel.overlap.vcf ${WORK_DIR}/ref/mousedb -buildver mm10 -out ${WORK_DIR}/${pos}.indel.overlap.vcf.anno -remove -protocol refGene -operation g -nastring . -vcfinput

perl awk_anno.pl ${WORK_DIR}/${pos}.indel.overlap.vcf.anno.mm10_multianno.txt ${WORK_DIR}/${pos}.indel.anno.tsv
awk '$10>0.1 {print $0}' ${WORK_DIR}/${pos}.indel.anno.tsv > ${WORK_DIR}/${pos}.indel.anno.0.1.tsv

# Sequence comparison with on-target site

cat ${WORK_DIR}/${pos}.snv.anno.0.1.tsv | while read line
do
...
perl mut_type.pl ${WORK_DIR}/${pos}.snv.overlap.vcf ${WORK_DIR}/${pos}.snv.muttype
